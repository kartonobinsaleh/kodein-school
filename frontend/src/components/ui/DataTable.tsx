...
import { Table, Thead, Tbody, Tr, Th, Td, Card, TableSkeleton } from '@/components/ui';
...
export function DataTable<T extends { id: string | number }>({
  ...
  return (
    <Card noPadding className="overflow-hidden border-2 border-gray-100 dark:border-gray-800 shadow-sm bg-white dark:bg-dark-card">
      <Table>
        <Thead>
